...
def load_img(path):
    ...
    resize_image = image_fromarray.resize(IN_SHAPE)
...
image_paths, steerings = load_img_steering(f'{datadir}/car_simulator_dataset/IMG', data)
...
model.save('Dave_STEERING_ANGLE')
