...
gen_report(){
    python post_fat_report_ssd.py --model_name ssd --experiment_name PREFAT_PEDESTRIAN --layer $1 --prefat --single_file --dataset pedestrian --dataset_path ./Self-Driving-Car-3
}
